...
<body>
    <div class="container">
        <div class="plans bg-border">
            <form action="<?php echo base_url('Welcome/questintsevenform') ?>" method="post"
                ...
                <div class="title">Q7. EKL focus model product strategy is defined for
                    <input type="hidden" name="question" value="Q7. EKL focus model product strategy is defined for ">
                </div>
                <label class=" plan basic-plan" for="lower">
                    <input type="radio" name="plan" value="A.Tehsil" id="lower">
                ...
                <label class="plan complete-plan" for="limits">
                    <input type="radio" id="limits" name="plan" value="B.	Region">
                    <div class="plan-content">
                ...
                <label class="plan complete-plan" for="complete">
                    <input type="radio" id="complete" name="plan" value="C.	Dealer">
                    <div class="plan-content">
                ...
                <label class="plan complete-plan" for="All">
                    <input type="radio" id="All" name="plan" value="D.State">
                    <div class="plan-content">
            ...
            function startTimer() {
                var timer = setInterval(function () {
                    ...
                    if (seconds <= 0) {
                        ...
                        window.location.href = "<?php echo base_url('question8'); ?>"; // Redirect to thanks page
                    }
