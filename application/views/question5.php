...
<body>
    <div class="container">
        <div class="plans bg-border">
            <form action="<?php echo base_url('Welcome/questintfiveform') ?>" method="post"
                ...
                <div class="title">Q5. As per new Demo Policy it is mandatory for the following dealers to own a Demo
                    tractor
                    <input type="hidden" name="question"
                        value="Q5. As per new Demo Policy it is mandatory for the following dealers to own a Demo tractor ">
                </div>
                <label class=" plan basic-plan" for="lower">
                    <input type="radio" name="plan" value="A.Dealers with 1000+ TIV" id="lower">
                    <div class="plan-content">

                        <div class="plan-details">
                            <span>A.Dealers with 1000+ TIV</span>
                ...
                <label class="plan complete-plan" for="limits">
                    <input type="radio" id="limits" name="plan" value="B.Dealer having 150+ sales volume annually">
                    <div class="plan-content">

                        <div class="plan-details">
                            <span>B.Dealer having 150+ sales volume annually</span>
                        </div>
                    </div>
                </label>
                <label class="plan complete-plan" for="complete">
                    <input type="radio" id="complete" name="plan" value="C.	Both a and b">
                    <div class="plan-content">
            ...
            function startTimer() {
                var timer = setInterval(function () {
                    ...
                    if (seconds <= 0) {
                        ...
                        window.location.href = "<?php echo base_url('question6'); ?>"; // Redirect to thanks page
                    }
