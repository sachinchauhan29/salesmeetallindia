...
<body>
    <div class="container">
        <div class="plans bg-border">
            <form action="<?php echo base_url('Welcome/questintfourform') ?>" method="post"
                ...
                <div class="title">Q4. DSE sufficiency is calculated as
                    <input type="hidden" name="question" value="Q4. DSE sufficiency is calculated as">
                </div>
                <label class=" plan basic-plan" for="lower">
                    <input type="radio" name="plan"
                        value="A.150 TIV or 20 tractor deliveries per DSE whichever is less, subject to minimum of 4 DSE"
                        id="lower">
                    <div class="plan-content">

                        <div class="plan-details">
                            <span>A.150 TIV or 20 tractor deliveries per DSE whichever is less, subject to minimum of 4
                                DSE</span>
                ...
                <label class="plan complete-plan" for="limits">
                    <input type="radio" id="limits" name="plan"
                        value="B.	200 TIV or 25 tractor deliveries per DSE whichever is higher, subject to minimum 4 DSE">
                    <div class="plan-content">

                        <div class="plan-details">
                            <span>B.200 TIV or 25 tractor deliveries per DSE whichever is higher, subject to minimum 4
                                DSE</span>
                        </div>
                    </div>
                </label>
                <label class="plan complete-plan" for="complete">
                    <input type="radio" id="complete" name="plan" value="C.	4 DSE, irrespective of TIV">
                    <div class="plan-content">

                        <div class="plan-details">
                            <span>C.4 DSE, irrespective of TIV</span>
                        </div>
                    </div>
                </label>
                <label class="plan complete-plan" for="All">
                    <input type="radio" id="All" name="plan" value="D.	None of the above">
                    <div class="plan-content">
            ...
            function startTimer() {
                var timer = setInterval(function () {
                    ...
                    if (seconds <= 0) {
                        ...
                        window.location.href = "<?php echo base_url('question5'); ?>"; // Redirect to thanks page
                    }
