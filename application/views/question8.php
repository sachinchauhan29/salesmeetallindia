...
<body>
    <div class="container">
        <div class="plans bg-border">
            <form action="<?php echo base_url('Welcome/questinteightform') ?>" method="post"
                ...
                <div class="title">Q8. Against 575XP plus, which POWERTRAC model to be positioned
                    <input type="hidden" name="question"
                        value="Q8. Against 575XP plus, which POWERTRAC model to be positioned ">
                </div>
                <label class=" plan basic-plan" for="lower">
                    <input type="radio" name="plan" value="A.Euro 42 Plus" id="lower">
                    <div class="plan-content">

                        <div class="plan-details">
                            <span>A.Euro 42 Plus</span>
                ...
                <label class="plan complete-plan" for="limits">
                    <input type="radio" id="limits" name="plan" value="B.Euro 45 Plus 4WD">
                    <div class="plan-content">

                        <div class="plan-details">
                            <span>B.Euro 45 Plus 4WD</span>
                        </div>
                    </div>
                </label>
                <label class="plan complete-plan" for="complete">
                    <input type="radio" id="complete" name="plan" value="C.Euro 47Plus PH">
                    <div class="plan-content">

                        <div class="plan-details">
                            <span>C.Euro 47Plus PH</span>
                        </div>
                    </div>
                </label>
                <label class="plan complete-plan" for="All">
                    <input type="radio" id="All" name="plan" value="D.Euro 50 Next">
                    <div class="plan-content">

                        <div class="plan-details">
                            <span>D. Euro 50 Next</span>
                        </div>
                    </div>
                </label>
            ...
            function startTimer() {
                var timer = setInterval(function () {
                    ...
                    if (seconds <= 0) {
                        ...
                        window.location.href = "<?php echo base_url('question9'); ?>"; // Redirect to thanks page
                    }
