...
<body>
    <div class="container">
        <div class="plans bg-border">
            <form action="<?php echo base_url('Welcome/questintxiiiform') ?>" method="post"
                ...
                <div class="title">Q13. As per commercial policy, a BG dealer will get interest free credit for how many
                    days?
                    <input type="hidden" name="question"
                        value="Q13. As per commercial policy, a BG dealer will get interest free credit for how many days? ">
                </div>
                <label class=" plan basic-plan" for="lower">
                    <input type="radio" name="plan" value="A.60 days" id="lower">
                ...
                <label class="plan complete-plan" for="limits">
                    <input type="radio" id="limits" name="plan" value="B.90 days">
                    <div class="plan-content">
                ...
                <label class="plan complete-plan" for="complete">
                    <input type="radio" id="complete" name="plan" value="C.45 days">
                    <div class="plan-content">
                ...
                <label class="plan complete-plan" for="All">
                    <input type="radio" id="All" name="plan" value="D.30 days">
                    <div class="plan-content">
            ...
            function startTimer() {
                var timer = setInterval(function () {
                    ...
                    if (seconds <= 0) {
                        ...
                        window.location.href = "<?php echo base_url('question14'); ?>"; // Redirect to thanks page
                    }
